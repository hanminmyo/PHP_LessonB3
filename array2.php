<?php
    ...
    $foods = [
        ...
        //krsort() => Associate array descending order accouding to key echo "<h1>K-R Sort</h1>";
        krsort($foods);
        foreach($foods as $key => $food) {
            echo "<h3>Key is <i>$key</i> and value is <i>$food</i>.</h3>";
        }
    ...
    //Array to string 
    $actors = ["Daung", "Pyay Ti 0o", "Lu Min", "Thet Mon Myint", "Paing Phyo Thu", "Eaindra Kyaw Zin", "Chit Thu Wai"];
    print_r($actors); 
    echo "<br>"; 
    echo gettype($actors);
